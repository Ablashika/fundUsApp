          ...
          <Image source={africanshop}  style={styles.image} >
            ...
            <View Style={styles.goal}>
                ...
                <View style={styles.textbox}>
                   ...
                   <Text  style={{ fontWeight:'bold',fontSize:22,marginVertical:20 ,alignSelf:'center'}}>{'Support Aunty Siisi get a new sewing machine.'}</Text>
 
           
                  <Text style={{fontSize:20,fontWeight: "bold",alignSelf:'flex-start',marginLeft:20}}>My Story:</Text>
                  <Text style={{ fontSize:15, marginBottom: 10, alignSelf: 'flex-start', marginHorizontal: 20 }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at rutrum odio.
